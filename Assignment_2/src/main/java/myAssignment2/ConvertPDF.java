    ...
    public static void PDF(){
        ...
        try {
            ...
            for (Table myTable : tableList){
                /*table.addCell(new PdfPCell(new Paragraph(String.valueOf(tableList.get(i).getNum()))));
                table.addCell(new PdfPCell(new Paragraph(String.valueOf(tableList.get(i).getName()))));
                table.addCell(new PdfPCell(new Paragraph(String.valueOf(tableList.get(i).getFieldID()))));
                table.addCell(new PdfPCell(new Paragraph(String.valueOf(tableList.get(i).getFed()))));
                table.addCell(new PdfPCell(new Paragraph(String.valueOf(tableList.get(i).getRtg()))));
                table.addCell(new PdfPCell(new Paragraph(String.valueOf(tableList.get(i).getClubCity())))); */
